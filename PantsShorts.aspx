<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="PantsShorts.aspx.cs" Inherits="PantsShorts" %>
    ...
    <asp:DataList ID="DataList1" runat="server" CellPadding="10" CellSpacing="10" DataSourceID="SqlDataSource1" RepeatColumns="4" OnItemCommand="DataList1_ItemCommand">
        <ItemTemplate>
            <a href="ChiTietMatHang.aspx?MaSP='<%# Eval("MASP") %>'" >
                <asp:Image ID="Image1" runat="server" ImageUrl='<%# "Image/"+Eval("HINHANH") %>' Height="169px" Width="214px" />
            </a>
<br />
...
<br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server"
        ...
        SelectCommand="SELECT * FROM SANPHAM WHERE MALOAI=5"
        ></asp:SqlDataSource>
    <p>
    </p>
</asp:Content>
