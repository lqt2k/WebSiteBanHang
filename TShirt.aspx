<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="TShirt.aspx.cs" Inherits="Laptop" %>
    ...
    <p>
        ...
        <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" RepeatColumns="4" CellPadding="10" CellSpacing="10" OnItemCommand="DataList1_ItemCommand">
            <ItemTemplate>
                ...
                <asp:Image ID="Image1" runat="server" ImageUrl='<%# "Image/"+Eval("HINHANH") %>' Height="166px" Width="213px" />
                </a>
                <br />
                <asp:Label ID="Label4" runat="server" Text='<%# Eval("DONGIA") %>' Font-Bold="True" ForeColor="#993300"></asp:Label>
