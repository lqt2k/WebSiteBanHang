...
public partial class Backpacks : System.Web.UI.Page
{
    ...
    protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        String tensp = ((Label)e.Item.FindControl("Label4")).Text;
        String giasp = ((Label)e.Item.FindControl("Label5")).Text;
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        if (DropDownList1.SelectedValue == "1")
            SqlDataSource1.SelectCommand = "SELECT * FROM SANPHAM WHERE MALOAI=3 ORDER BY TENSP ASC";
        else if (DropDownList1.SelectedValue == "2")
            SqlDataSource1.SelectCommand = "SELECT * FROM SANPHAM WHERE MALOAI=3 ORDER BY TENSP DESC";
        else if (DropDownList1.SelectedValue == "3")
            SqlDataSource1.SelectCommand = "SELECT * FROM SANPHAM WHERE MALOAI=3 ORDER BY DONGIA ASC";
        else
            SqlDataSource1.SelectCommand = "SELECT * FROM SANPHAM WHERE MALOAI=3 ORDER BY DONGIA DESC";
    }
}