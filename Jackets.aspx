<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="Jackets.aspx.cs" Inherits="Jackets" %>
    ...
    <p>
        ...
        <asp:DataList ID="DataList1" runat="server" CellPadding="10" CellSpacing="10" DataSourceID="SqlDataSource1" RepeatColumns="4" OnItemCommand="DataList1_ItemCommand">
            <ItemTemplate>
                ...
                <asp:Image ID="Image1" runat="server" ImageUrl='<%# "Image/"+Eval("HINHANH") %>' Height="182px" Width="199px" />
                    </a>
<br />
...
<br />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
            ...
            SelectCommand="SELECT * FROM SANPHAM WHERE MALOAI=6"
            ></asp:SqlDataSource>
    </p>
</asp:Content>
